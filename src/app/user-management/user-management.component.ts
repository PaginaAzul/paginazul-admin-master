...
export class UserManagementComponent implements OnInit {
  ...
  getViewData() {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/admin/userList', apireq, 1).subscribe((success: any) => {
  ...
  createExcel() {
    ...
    this.spinner.show();
    this.service.postApi("/api/v1/admin/createExcel", apireq, 1).subscribe(success => {
      if (success.response_code == 200) {
        this.spinner.hide();
        this.service.succ(success.response_message)
        this.getViewData()
  ...
  addUser1() {
    ...
    this.service.formdataApi("/api/v1/admin/addUser", this.formdata).subscribe(success => {
  ...
  getAdminData() {
    ...
    this.service.postApi('/api/v1/admin/getAdminDetail', apireq, 1).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.userArr1 = success.Data
      }
      else {
        this.service.err("Something went wrong")
      }
