...
export class DriverComponent implements OnInit {
  ...
  file: any
  professionalAboutUs: any;
  professionalEmergencyContact: any;
  totalItems: any;
  sendNotificationForm: FormGroup;
  sendNotificationToAllForm: FormGroup;
  mailForm: any;
  dropDownData3: string[];
  dropDownData4: string[];
  minimumOfferLimitProfessional: any;
  orderForProfessionalDistance: any;
  dropDownData6: { "name": string; "dial_code": string; "code": string; }[];
  type: any;

  constructor(public service: AppService, private spinner: NgxSpinnerService, public router: Router, private activatedRoute: ActivatedRoute,) { }
  ...
  searchFormVAlue() {
    ...
    this.dropDownData = ['Male', 'Female'],
      this.dropDownData1 = ['English', 'Portuguese'],
      this.dropDownData2 = ['English', 'Portuguese']
      this.dropDownData3 = ['India', 'Angola']
  ...
  getViewData() {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/admin/getDriverList', apireq, 1).subscribe((success: any) => {
  ...
  search(data) {
    ...
    this.service.postApi('/api/v1/admin/getDriverList', apireq, 0).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.spinner.hide();
        this.userArr = success.Data.docs;
        this.limit = success.Data.limit;
  ...
  deleteApi() {
    ...
    this.spinner.show();
    this.service.postApi("/api/v1/admin/deleteDriver", deleteData, 0).subscribe((data: any) => {
  ...
  blockApi(status, modal) {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/admin/updateStatusDriver', apireq, 1).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.spinner.hide();
        this.getViewData()
        $('#' + modal).modal('hide')
  ...
  rejectApi(status, modal) {
    ...
    let apireq = {
      "driverId": this.userId,
      "adminVerifyStatus": status
    }

    this.spinner.show();
    this.service.postApi('/api/v1/admin/updateDriverDocumentStatus', apireq, 1).subscribe((success: any) => {
  ...
  addUser1() {
    ...
    this.service.formdataApi("/api/v1/admin/professionalWorker", this.formdata).subscribe(success => {
      if (success.body.response_code == 200) {
        ...
        $("#addUser").modal('hide')
        this.router.navigate(['/admin/professionalworkerManagement/']);
        this.addUserForm.reset();
        this.getViewData()
        this.formvalidation.submitted = false
        this.spinner.hide();
