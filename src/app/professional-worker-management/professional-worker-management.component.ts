...
@Component({
  selector: 'app-professional-worker-management',
  templateUrl: './professional-worker-management.component.html',
  styleUrls: ['./professional-worker-management.component.css']
})
export class ProfessionalWorkerManagementComponent implements OnInit {
  ...
  getViewData() {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/admin/getProfessionalWorkers', apireq, 1).subscribe((success: any) => {
  ...
  search(data) {
    ...
    this.service.postApi('/api/v1/admin/getProfessionalWorkers', apireq, 0).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.spinner.hide();
        this.userArr = success.Data.docs;
        this.limit = success.Data.limit;
